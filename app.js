...
// Data fetch aur save karne ke liye 'window.db' ka use kar rahe hain
...
async function initDB() {
    try {
        ...
        console.error("Initialization error (Firebase Rules Issue?): ", err);
    }
}
initDB();
...
function setLoginType(type, btn) {
    ...
    // Show/Hide New Manager Registration Link
...
document.getElementById('login-form').addEventListener('submit', async (e) => {
    ...
    try {
        ...
        alert("Database Error! Loading atak gaya kyunki Database connect nahi ho paya. Firebase Rules check karein. Error: " + err.message);
    } finally {
        btn.innerText = "Login";
    }
});
...
async function loadStudentDashboard() {
    ...
    // STUDENT MEMBER LIST: HIDE ID LOGIC
...
async function loadManagerDashboard() {
    ...
    // MANAGER NOTEBOOK TABLE POPULATION
    ...
    // Filter pending payments for THIS MANAGER'S HOSTEL ONLY
